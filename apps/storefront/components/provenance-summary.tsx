    ...
    <section className={`rounded-3xl border border-black/10 bg-white ${compact ? 'p-4' : 'p-6'} shadow-sm`}>
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <h3 className={`${compact ? 'mt-1 text-base' : 'mt-2 text-xl'} font-semibold`}>What supports this view</h3>
          {compact ? <p className="mt-2 text-sm leading-6 text-black/60">{provenance.dataSource}, {provenance.normalizationState}.</p> : null}
        </div>
